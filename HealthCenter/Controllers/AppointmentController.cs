...
using Model = HealthCenter.Models.AppModel;
...
public class AppointmentController : ControllerBase
{
    ...
    [HttpPost("filter")]
    public async Task<IActionResult> GetAll([FromBody] AppFilModel model)
    {
        var where = "WHERE 1 = 1";
        ...
        var records = await connection.QueryAsync<AppGetModel>(query);
        return Ok(records);
    }
