...
import {IModel as IPatModel} from '../patient/patient.component';
...
export class DoctorComponent {
  ...
  highlightRecords!: Array<IPatModel>;

  constructor(private readonly http: HttpClient,
    @Inject('BASE_URL') private readonly baseUrl: string,
    private readonly formBuilder: FormBuilder,) {
    this.records = new Array<IModel>();
    this.highlightRecords = new Array<IPatModel>();
    this.buildForm();
  }
  ...
  onHighlight = (record: IModel) => {
    ...
    this.http.get<IPatModel[]>(this.baseUrl + "doctor-patient/" + record.doctorId).subscribe(result => {
