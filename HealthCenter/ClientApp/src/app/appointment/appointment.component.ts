...
import {IModel as IPatModel, ROUTE_NAME as PATIENT_ROUTE_NAME} from '../patient/patient.component';
...
export class AppointmentComponent {
  ...
  fetchPatients = () => {
    this.http.get<IPatModel[]>(this.baseUrl + PATIENT_ROUTE_NAME).subscribe(result => {
